...
import { MempoolStream } from "../components/ArbRoadmap";
import {
  CexDexPanel,
  LiquidationPanel,
  CrossChainPanel,
...
export default function ExecutionDashboard({ color = "#A78BFA" }) {
  ...
  const filteredOpps = (
    ...
    const matchesSearch =
      routeStr.toLowerCase().includes(search) ||
      ...
      {!isOnline ? (
        ...
        >
          ...
          <div style={{ fontSize: 13, color: "#94A3B8", marginBottom: 6 }}>
            Rust Execution Engine is currently offline.
          </div>
          <div style={{ fontSize: 11, color: "#475569" }}>
            Run <code>cargo run --bin arb-engine</code> to start receiving
            mempool data.
          </div>
        </div>
      ) : (
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    Real-time sandbox simulation & core orchestration logs
                  </span>
                </div>
              </div>
              <div
                ...
                style={{
                  ...
                  overflowY: "auto",
                  fontFamily:
                    "'Fira Code', 'IBM Plex Mono', 'Courier New', monospace",
                  fontSize: "10px",
                  lineHeight: "1.5",
                  background: "#020305",
                  display: "flex",
          ...
          >
            ...
            >
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                >
                  Live Bellman-Ford pathfinding results. Displays profitable
                  cyclic routes across DEXs.
                </span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <input
                ...
                <thead>
                  ...
                  >
                    ...
                    <th
                      ...
                      title="The sequential DEX path evaluated by Bellman-Ford"
                    >
                      PATHWAY / LIQUIDITY ROUTE
                    </th>
                    <th
                      style={{
                        padding: "10px 16px",
                    ...
                    <th
                      ...
                      title="Amount of tokens inputted (e.g. flash loan size)"
                    >
                      INPUT
                    </th>
                    <th
                      ...
                      title="Total output token value before gas deduction"
                    >
                      GROSS YIELD
                    </th>
                    <th
                      ...
                      title="Estimated base L2 gas cost in USD"
                    >
                      GAS COST
                    </th>
                    <th
                      ...
                      title="Maximum gwei we can bid (Priority Gas Auction) and still break even"
                    >
                      MAX PGA TIP
                    </th>
                    <th
                      ...
                      title="Net Expected Value in USD after gas costs (must be >0 for execution)"
                    >
                      NEV (PROFIT)
                    </th>
                    <th
                    ...
                    <tr>
                      <td colSpan="9">
                        ...
                        >
                          ...
                          >
                            SCANNING GRAPH FOR NEGATIVE CYCLES...
                          </div>
                          <div
                            style={{
                              fontSize: 10,
                          ...
                          >
                            The Bellman-Ford algorithm is analyzing the updated
                            reserves from the mempool feed to find profitable
                    ...
                    filteredOpps.map((opp, i) => {
                      ...
                      return (
                        <tr
                          ...
                          style={{
                            borderBottom:
                              i < filteredOpps.length - 1
                                ? "1px solid #0D1117"
                                : "none",
                            background: opp.isExecutable
                              ? "rgba(0,255,209,0.02)"
                              : "transparent",
                        ...
                        >
                          ...
                          <td
                            style={{ padding: "10px 16px", color: "#CBD5E1" }}
                          >
                            {renderRouteChevrons(opp.route)}
                          </td>
                          <td
                            style={{
                              padding: "10px 16px",
                          ...
                          >
                            <a
                              href={`https://basescan.org/block/${opp.block}`}
                              target="_blank"
                          ...
                          >
                            {opp.optimalGasGwei !== undefined ? (
                              <span
                                style={{
                                  background:
                                    opp.optimalGasGwei > (opp.baseGasGwei || 0)
                                      ? "rgba(255, 215, 0, 0.15)"
                                      : "transparent",
                                  color:
                                    opp.optimalGasGwei > (opp.baseGasGwei || 0)
                          ...
                          <td
                            style={{
                              padding: "10px 16px",
                              fontFamily: "monospace",
                              color: isProfitable ? "#00FFD1" : "#FF6B6B",
                              fontWeight: 700,
                            }}
                          >
          ...
          >
            ...
            >
              <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                ...
                >
                  Loaded pools currently included in Bellman-Ford execution
                  arbitrage.
                </span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                >
                  Total Pools:{" "}
                  <strong style={{ color: "#00FFD1" }}>{pools.length}</strong>
                </span>
                <input
                  type="text"
                  ...
                  {pools.length === 0 ? (
                    ...
                    pools
                      ...
                      .map((pool) => {
                        ...
                        if (dexLower.includes("uniswap"))
                        ...
                        else if (dexLower.includes("aerodrome"))
                          dexTheme = {
                          ...
                          dexTheme = {
                            bg: "rgba(250, 82, 160, 0.1)",
                            text: "#FA52A0",
                            border: "rgba(250, 82, 160, 0.2)",
                          };
                        else if (dexLower.includes("pancake"))
                          dexTheme = {
                            bg: "rgba(31, 199, 212, 0.1)",
                            text: "#1FC7D4",
                            border: "rgba(31, 199, 212, 0.2)",
                          };
                        ...
                        return (
                          <tr
                            key={pool.id}
                            style={{
                              borderBottom: "1px solid rgba(26, 34, 51, 0.5)",
                              transition: "background 0.2s",
                            }}
                            onMouseEnter={(e) =>
                              ...
                              >
                                <div
                                  style={{
                                    ...
                                    borderRadius: "50%",
                                    background:
                                      "linear-gradient(135deg, #0052FF, #00D1FF)",
                                  }}
                                />
                                <span
                                  style={{
