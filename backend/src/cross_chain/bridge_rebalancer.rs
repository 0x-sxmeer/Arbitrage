...
impl BridgeRebalancer {
    pub fn new() -> Self {
        ...
        stargate_pools.insert(
            ChainId::Base,
            "0x27a16dc786820B16E5c9028b75B99F6f604b5d26".to_string(),
        );
        stargate_pools.insert(
            ChainId::Optimism,
            "0xDecC0c09c3B5f6e92EF4184125D5648a66E35298".to_string(),
        );
        stargate_pools.insert(
            ChainId::Arbitrum,
            "0x892785f33CdeE22A30AEF750F285E18c18040c3e".to_string(),
        );

        let mut lz_endpoints = HashMap::new();
        lz_endpoints.insert(
            ChainId::Base,
            "0xb6319cC6c8c27A8F5dAF0dD3DF91EA35C4720dd7".to_string(),
        );
        lz_endpoints.insert(
            ChainId::Optimism,
            "0x3c2269811836af69497E5F486A85D7316753cf62".to_string(),
        );
        lz_endpoints.insert(
            ChainId::Arbitrum,
            "0x3c2269811836af69497E5F486A85D7316753cf62".to_string(),
    ...
    fn select_provider(&self, _from: ChainId, _to: ChainId, amount_usd: f64) -> BridgeProvider {
