...
use alloy::{
    primitives::Address, rpc::types::TransactionRequest, signers::local::PrivateKeySigner,
};
...
impl FlashbotsSubmitter {
    pub fn new(
        ...
        let signing_key: PrivateKeySigner = signing_key_hex
            .parse()
    ...
    #[allow(dead_code)]
    pub async fn submit_bundle(&self, tx: TransactionRequest, target_block: u64) -> Result<String> {
    ...
    pub async fn submit_raw_bundle(
        ...
        let hex_txs: Vec<String> = bundle_txs
            .iter()
