...
impl EngineMetrics {
    ...
    pub async fn add_recent_opportunity(
        &self,
        opp: &crate::arb::opportunity::ArbitrageOpportunity,
        eth_price: f64,
        btc_price: f64,
    ) {
    ...
    pub fn inc_txs_seen(&self) {
        self.txs_seen.fetch_add(1, Ordering::Relaxed);
    }
    pub fn inc_txs_filtered(&self) {
        self.txs_filtered.fetch_add(1, Ordering::Relaxed);
    }
    pub fn inc_txs_decoded(&self) {
        self.txs_decoded.fetch_add(1, Ordering::Relaxed);
    }
    ...
    pub fn inc_router_scans(&self) {
        self.router_scans.fetch_add(1, Ordering::Relaxed);
    }
    pub fn inc_opportunities_found(&self) {
        self.opportunities_found.fetch_add(1, Ordering::Relaxed);
    }
    pub fn inc_opportunities_executable(&self) {
        self.opportunities_executable
            .fetch_add(1, Ordering::Relaxed);
    }
    pub fn inc_opportunities_persisted(&self) {
        self.opportunities_persisted.fetch_add(1, Ordering::Relaxed);
    }
    pub fn inc_ws_reconnections(&self) {
    ...
    pub fn inc_pg_errors(&self) {
        self.pg_errors.fetch_add(1, Ordering::Relaxed);
    }
    pub fn inc_txs_dropped(&self) {
        self.txs_dropped.fetch_add(1, Ordering::Relaxed);
    }

    pub fn set_graph_pools(&self, n: u64) {
        self.graph_pools.store(n, Ordering::Relaxed);
    }
    pub fn set_graph_tokens(&self, n: u64) {
        self.graph_tokens.store(n, Ordering::Relaxed);
    }
