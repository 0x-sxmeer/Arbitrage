...
async fn main() -> Result<()> {
    ...
    let aero_factory_addr = Address::from_str("0x420DD381b31aEf6683db6B902084cB0FFECe40Da").unwrap();
    ...
    let slipstream_factory_addr = Address::from_str("0x5e7bb104d84c7cb9b682aac2f3d509f5f406809a").unwrap();
    ...
    match slipstream_factory.getPool(weth, usdc, ts).call().await {
        Ok(res) => println!("Aerodrome Slipstream WETH/USDC Pool (ts=50): {:?}", res.pool),
