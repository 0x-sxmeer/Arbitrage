    ...
    function run() public {
        ...
        if (aavePool == address(0) || wormholeRelayer == address(0)) {
            ...
            if (chainId == 11155111) {
                ...
                if (wormholeRelayer == address(0)) wormholeRelayer = 0x706F82e9bb5b0813501714Ab5974216704980e31;
            } else if (chainId == 42161) {
                // Arbitrum Mainnet
                if (aavePool == address(0)) aavePool = 0x794a61358D6845594F94dc1DB02A252b5b4814aD;
                if (wormholeRelayer == address(0)) wormholeRelayer = 0x27428Dd2D3Abb50BaC90940428B7bB9662758ebA;
            } else if (chainId == 1) {
                // Ethereum Mainnet
