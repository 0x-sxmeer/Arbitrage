    ...
    milestones: [
      {
        ...
        detail:
          "Implement x·y=k (V2), tick-based concentrated liquidity (V3), and StableSwap invariants for Curve pools.",
        stack: ["Rust", "fixed-point math", "uint256"],
        status: "planned",
        completion: 0,
      },
      {
      ...
      {
        id: "m2-4",
        title: "Slippage Estimator",
        detail:
          "Simulate exact output for a given input size before submitting. Abort if output deviates >0.3% from estimate.",
        stack: ["Simulation engine", "fork testing"],
        status: "planned",
        completion: 0,
      },
    ],
    ...
    milestones: [
      {
        ...
        detail:
          "Solidity (EVM) + Anchor (Solana). Single tx bundles: if final output < input + gas, entire tx reverts. Zero loss guarantee.",
        stack: ["Solidity", "Anchor/Rust", "Hardhat"],
        status: "planned",
        completion: 0,
      },
      {
        ...
        detail:
          "Integrate Aave V3 + Balancer flashloans. Execute $100k+ arb with zero upfront capital. Repay in same block.",
        stack: ["Aave V3", "Balancer", "Solidity"],
        status: "planned",
        completion: 0,
      },
      {
        ...
        detail:
          "Submit bundles via Flashbots RPC (Ethereum) and Skip Protocol (Cosmos). Private mempool = no sandwich attacks.",
        stack: ["Flashbots", "Skip Protocol", "MEV-Share"],
        status: "planned",
        completion: 0,
      },
      {
        ...
        detail:
          "Fork mainnet with Anvil. Run 10,000+ simulated arb scenarios against historical data before touching real funds.",
        stack: ["Anvil", "Foundry", "Hardhat"],
        status: "planned",
        completion: 0,
      },
    ],
